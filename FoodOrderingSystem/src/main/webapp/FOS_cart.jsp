						...
						<table class="table">
				          ...
				          <td class="total-price">$44.99</td>
						    ...
						    <tr class="alert" role="alert">
						    	...
						    	<td>
						    		<div class="img" style="background-image: url(f2.png);"></div>
						    	</td>
						      <td>
						      	<div class="email">
						      		<span>Sneakers Shoes 2020 For Men </span>
						      ...
						      <td class="quantity">
					        	<div class="input-group">
				             	<input type="text" name="quantity" class="quantity form-control input-number" value="1" min="1" max="100" data-price="30.99">
				          	</div>
				          </td>
				          <td class="total-price">$30.99</td>
						      <td>
						      	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
				            	<span aria-hidden="true"><i class="fa fa-close"></i></span>
				          	</button>
						    ...
						    <tr class="alert" role="alert">
						    	...
						    	<td>
						    		<div class="img" style="background-image: url(f3.png);"></div>
						    	</td>
						      <td>
						      	<div class="email">
						      		<span>Sneakers Shoes 2020 For Men </span>
				          ...
				          <td>$35.50</td>
						    ...
						    <tr class="alert" role="alert">
						    	...
						    	<td>
						    		<div class="img" style="background-image: url(f4.png);"></div>
						    	</td>
						      <td>
						      	<div class="email">
						      		<span>Sneakers Shoes 2020 For Men </span>
				          ...
				          <td>$76.99</td>
						    ...
						    <tr class="alert" role="alert">
						    	...
						    	<td class="border-bottom-0">
						    		<div class="img" style="background-image: url(f5.png);"></div>
						    	</td>
						      <td class="border-bottom-0">
						      	<div class="email">
						      		<span>Sneakers Shoes 2020 For Men </span>
